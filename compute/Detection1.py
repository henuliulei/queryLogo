...
from data.dataset import GetTestLogoset1
...
def drawBBox(mask,imgpath):
    ...
    if (xMax - xMin) == 1:
        ...
        xMin = xMin * (targetWidth/maskWidth)
...
def Totest():
    ...
    queryList, targetList,pathtargetList,gtpath = GetTestLogoset1()
    predictResult = []
...
if __name__ == '__main__':
    #output = getMask("D:\\PIC\\NewData\\yanshi\\query2.jpg","D:\\PIC\\NewData\\yanshi\\baidu.png")
